...
public interface ReportProductJPA extends JpaRepository<ReportProduct, Integer> {
        ...
        @Query("""
                        ...
                        """)
        Page<ReportProduct> findReportProductsByActiveByShop(
                        @Param("active") Boolean active,
                        @Param("userId") Integer userId,
                        Pageable pageable);
        ...
        @Query("""
                        ...
                        """)
        int countByActiveByShop(
                        @Param("active") Boolean active,
                        @Param("userId") Integer userId);

        @Query("SELECT r FROM ReportProduct r WHERE r.user.id = :userId ")
        Page<ReportProduct> findAllByShopId(@Param("userId") Integer userId, Pageable pageable);
        ...
        @Query("""
                        ...
                        """)
        Page<ReportProduct> findAllReportProductByShopId(
        ...
        @Query("""
                        ...
                        """)
        Page<ReportProduct> findReportProductsByActiveByProductId(
                        @Param("active") Boolean active,
                        @Param("shopId") Integer shopId,
                        Pageable pageable);
        ...
        @Query("""
                        ...
                        """)
        int countAllByActiveByProductId(
                        @Param("shopId") Integer shopId);
