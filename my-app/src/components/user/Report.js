...
const Report = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append('productCode', id);
      ...
      const response = await axiosInstance.post('user/report/product/add', formDataToSend, {
        headers: {
      ...
      if (response.status === 200 && response.data.status === true) {
        showSuccessToast('Báo cáo sản phẩm thành công');
        navigate(-1);
      }
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <div className="border-b border-gray-200 pb-6 mb-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Báo cáo sản phẩm</h1>
          <p className="text-gray-600">
            Vui lòng cho chúng tôi biết lý do bạn muốn báo cáo sản phẩm mã: {id} này.
          </p>
        </div>
        {/* Form báo cáo */}
