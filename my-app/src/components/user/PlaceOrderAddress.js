                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <div className="flex flex-col space-y-2 ml-4">
                                                ...
                                                <button
                                                    ...
                                                    className="mt-2 px-3 py-1.5 text-xs border border-gray-300 rounded-lg text-gray-700 hover:bg-green-500 hover:text-white cursor-pointer transition-colors"
                                                >
                                                    Chọn địa chỉ này
                                                </button>
                                            </div>
