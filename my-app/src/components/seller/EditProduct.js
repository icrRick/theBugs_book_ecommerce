...
const EditProduct = () => {
  ...
  const authorOptions = [
    ...
    { value: 'author2', label: 'Tô Hoài' },
    { value: 'author3', label: 'Nam Cao' },
  ];

  const categoryOptions = [
    { value: 'cat1', label: 'Văn học' },
    { value: 'cat2', label: 'Thiếu nhi' },
    { value: 'cat3', label: 'Kinh tế' },
  ];

  const publisherOptions = [
    { value: 'pub1', label: 'NXB Kim Đồng' },
    { value: 'pub2', label: 'NXB Trẻ' },
    { value: 'pub3', label: 'NXB Giáo Dục' },
  ];
  ...
  useEffect(() => {
    ...
    const fetchProductData = async () => {
      ...
      const mockProduct = {
        ...
        description: 'Một tác phẩm nổi tiếng của Nguyễn Nhật Ánh',
        weight: '300',
        price: '85000',
        quantity: '100',
        categories: [{ value: 'cat1', label: 'Văn học' }],
        authors: [{ value: 'author1', label: 'Nguyễn Nhật Ánh' }],
  ...
  return (
    <div className="my-6">
      ...
      <div className="mb-10 text-center">
        <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">Chỉnh Sửa Sản Phẩm</h1>
        <p className="mt-3 text-lg text-gray-600 max-w-2xl mx-auto">Cập nhật thông tin sản phẩm của bạn</p>
      </div>
            ...
            <div className="space-y-10">
                ...
                <div className="flex items-center space-x-2 mb-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Cập nhật thông tin chính về cuốn sách.
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-10 border-t border-gray-200">
                <div className="flex items-center space-x-2 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">Phân loại</h3>
                    <p className="mt-1 text-sm text-gray-500">
                      Cập nhật thể loại và thông tin phân loại.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <div className="mt-2 border">
                      <Select
                        ...
                        onChange={(selected) => handleSelectChange(selected, { name: 'categories' })}
                  ...
                  <div>
                    ...
                    <div className="mt-2 border">
                      <Select
                        ...
                        onChange={(selected) => handleSelectChange(selected, { name: 'authors' })}
                        className="basic-multi-select"
                        classNamePrefix="select"
                  ...
                  <div className="mt-2 border">
                    <Select
                      ...
                      onChange={(selected) => handleSelectChange(selected, { name: 'publisher' })}
                      className="basic-multi-select"
                      classNamePrefix="select"
                  ...
                  <div className="flex justify-center rounded-lg border-2 border-dashed border-gray-300 px-6 py-10 transition-colors duration-200 hover:border-blue-400">
                    <div className="text-center">
                      ...
                      <div className="mt-4 flex text-sm leading-6 text-gray-600">
                        <label htmlFor="images" className="relative cursor-pointer rounded-md bg-white font-semibold text-blue-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-600 focus-within:ring-offset-2 hover:text-blue-500 transition-colors duration-200">
