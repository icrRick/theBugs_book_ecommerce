...
const SellerReportShops = () => {
  ...
  const fetchData = async (active, page) => {
    try {
      const response = await axiosInstance.get(
        `/seller/report/shop/list?active=${active}&page=${page}`
      );
  ...
  return (
    <div>
      <h2 className="text-lg font-semibold">Báo cáo cửa hàng</h2>
...
export default SellerReportShops;
