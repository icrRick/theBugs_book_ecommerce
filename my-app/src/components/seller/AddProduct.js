...
const AddProduct = () => {
  ...
  return (
    ...
    <div className="mb-10 text-center">
      <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">Thêm Sản Phẩm Mới</h1>
      <p className="mt-3 text-lg text-gray-600 max-w-2xl mx-auto">Điền đầy đủ thông tin để thêm sách mới vào cửa hàng của bạn</p>
    </div>
