...
const Promotions = () => {
  ...
  const confirmDelete = async (id) => {
    try {
      // Gọi API xóa voucher
      const response = await axiosInstance.post(`/seller/promotion/delete?id=${id}`);
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 mb-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 mb-1">Quản lý khuyến mãi</h1>
            <p className="text-sm text-gray-600">Quản lý và theo dõi các chương trình khuyến mãi của bạn</p>
          </div>
                  ...
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        <span className="text-3xl font-bold text-red-600">-{promotion?.promotionValue}%</span>
                      ...
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(promotion.status)}`}>
                        {promotion?.status}
                      </span>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center text-sm">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="font-medium text-gray-900">{promotion?.startDate} - {promotion?.expireDate}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center text-sm">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="font-medium text-gray-900">{promotion?.createdAt}</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Bạn có chắc chắn muốn xóa promotion <span className="text-sm font-bold text-red-600">-{selectedItem?.promotionValue}%</span> này? Hành động này không thể hoàn tác.
                      </p>
                    </div>
                  </div>
                </div>
