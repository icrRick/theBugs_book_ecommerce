  ...
  const menuItems = [
    {
      ...
      icon: (
        <svg
          className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-emerald-600"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      items: [
        {
          ...
          icon: (
            <svg
              className="w-4 h-4 mr-2 text-gray-500 transition duration-75 group-hover:text-emerald-600"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth="2"
            d="M11 3v18m-4-4h4m4-6h4m-4-4h4"
          />
        </svg>
      ),
      items: [
          ...
          icon: (
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M3 10h18M5 21h14a2 2 0 002-2v-7H3v7a2 2 0 002 2zM3 10l1-7h16l1 7"
              />
            </svg>
          ),
        },
        ...
        <ul className="space-y-2">
          ...
          {dropdownMenus.map((menu, index) => (
            <li key={index}>
              ...
              >
                {menu.icon}
                <span className="flex-1 ml-3 text-left font-medium">
                  {menu.title}
                </span>
                <svg
