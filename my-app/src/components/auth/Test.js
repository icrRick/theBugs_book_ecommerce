        ...
        <div className="flex items-center justify-center p-4">
            <div className="max-w-3xl w-full space-y-8">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div className="flex">
                        <div
                            className="hidden md:block w-1/2 h-auto md:h-[640px] bg-cover bg-center"
                            style={{
                                backgroundImage:
                                ...
                                <div>
                                    ...
                                    <div className="relative rounded-md shadow-sm">
                                        ...
                                        <input
                                            ...
                                            className={`py-2 pl-10 block w-full border ${errors.fullName
                                ...
                                <div>
                                    ...
                                    <div className="relative rounded-md shadow-sm">
                                        ...
                                        <input
                                            ...
                                            className={`py-2 pl-10 block w-full border ${errors.phone
                                                ? "border-red-300 focus:ring-red-500 focus:border-red-500"
                                                : "border-gray-300 focus:ring-emerald-500 focus:border-emerald-500"
                                                } rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 sm:text-sm`}
                                ...
                                <div>
                                    ...
                                    <div className="relative rounded-md shadow-sm">
                                        ...
                                        <input
                                            ...
                                            className={`py-2 pl-10 pr-10 block w-full border ${errors.confirmPassword
                                                ? "border-red-300 focus:ring-red-500 focus:border-red-500"
                                                : "border-gray-300 focus:ring-emerald-500 focus:border-emerald-500"
                                                } rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 sm:text-sm`}
                                            placeholder="••••••••"
